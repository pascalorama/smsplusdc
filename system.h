...
typedef struct
{
    int enabled;
    int bufsize;
    signed short buffer[2][1000];
    signed short fm_buffer[1000];        /* internal use only */
    signed short psg_buffer[2][1000];    /* internal use only */
    int log;
